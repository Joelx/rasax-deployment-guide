...
data_path="/app/mydata/BASE8RGPH24V4_all_18_12_ID"
data_path='/app/mydata/BASE8RGPH24V5_all_08_01_ID'
...
pkl_path=data_path + BERTmodel_name.split('/')[0]+'_situations_embeddings.pkl'
